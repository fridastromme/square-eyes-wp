...
const purchaseContainer = document.querySelector ('.purchase__container');
...
async function fetchMovie () {
  try {
    ...
    metaTitle.innerHTML = 'Square Eyes | Purchase «' + `${details.name}` + '»';
    ...
    detailsContainer.innerHTML = `<img src="${details.images[0].src}" alt="${details.name}"/ class="details-image">
